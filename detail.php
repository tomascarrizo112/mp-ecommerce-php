                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <?php
                                    ...
                                    $item->picture_url = 'https://cato5752210-mp-commerce-php.herokuapp.com/'.$_POST['img'];
                                    ...
                                    $preference->back_urls = array(
                                        "success" => "https://cato5752210-mp-commerce-php.herokuapp.com/success.php",
                                        "failure" => "https://cato5752210-mp-commerce-php.herokuapp.com/failure.php",
                                        "pending" => "https://cato5752210-mp-commerce-php.herokuapp.com/pending.php"
                                    );
                                    $preference->notification_url = "https://cato5752210-mp-commerce-php.herokuapp.com/ipn.php";
                                    $preference->auto_return = "approved";
                                    $preference->external_reference = 'tomas_jozami@yahoo.com';
                                    $preference->save();
